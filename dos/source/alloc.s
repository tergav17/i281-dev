...
FFREE:	LOADI	B,AL4_B
	...
	; ALLOCATE A FILE
	; A FILE RECORD WILL BE RESERVED AND A NEW FILE BLOCK TABLE
	; WILL BE ALLOCATED
	; THE FILE WILL BE GIVEN THE NAME OF THE CURRENT FILE MATCH PARAMETER
	; NO WILDCARDS SHOULD APPEAR IN THE MATCH STRING
	; USES: A, B, C, M0, M1, M2
FALLOC:	LOADI	B,AL5_B
	LOADI	C,FALLOCA
	JUMP	INDIR
...
FALLOCA:SUBI	D,2
	...
	; LETS ALLOCATE A BLOCK FOR THE FBT NOW
	LOADI	C,@+5
	STOREF	[D],C
	LOADI	B,AL0_B
	LOADI	C,ALLOC
	...
	STOREF	[C+14],B
	LOADI	A,0
	STOREF	[C+10],A	; RESET FILE SIZE WHILE WE ARE HERE
	STOREF	[C+11],A
	LOADI	A,WORK_B
	STORE	[DBANK],A
	
	; COPY PATTERN INTO FILE RECORD
	LOADI	D,9
0:	LOADI	C,MATCH
	LOAD	B,[SRCH_RP]
	LOAD	A,[SRCH_BK]
